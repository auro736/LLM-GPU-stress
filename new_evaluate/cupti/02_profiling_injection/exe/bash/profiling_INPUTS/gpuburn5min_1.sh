...
env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-burnCustom/gpu_burn -i 0 -c ./test-apps/gpu-burnCustom/compare.ptx -m 50% > data/raw/INPUTS/gpuburn5min1_$INJECTION_KERNEL_COUNT.txt 300 1