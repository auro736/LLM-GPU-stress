...
export INJECTION_METRICS=$INJECTION_METRICS"smsp__inst_executed_pipe_cbu.sum " # cf_executed
export INJECTION_METRICS=$INJECTION_METRICS"smsp__inst_executed_pipe_adu.sum " # cf_executed
...
env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-burn/gpu_burn -i 0 -c ./test-apps/gpu-burn/compare.ptx -m 50% > data/raw/NCU/gpuburn5min_$INJECTION_KERNEL_COUNT.txt 300