...
export INJECTION_METRICS=$INJECTION_METRICS"sass__inst_executed_register_spilling.avg.pct_of_peak_sustained_active " # stall_memory_throttle


env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-burnSA/gpu_burn -i 0 -c ./test-apps/gpu-burnSA/compare.ptx -m 50% > data/raw/INPUTSSA/gpuburn5min4_$INJECTION_KERNEL_COUNT.txt 300 0.00000000000000000000000000000000029180756 15419547000000000000000000000000000