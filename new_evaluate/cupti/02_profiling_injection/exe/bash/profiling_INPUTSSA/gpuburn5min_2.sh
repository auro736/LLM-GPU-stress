...
env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-burnSA/gpu_burn -i 0 -c ./test-apps/gpu-burnSA/compare.ptx -m 50% > data/raw/INPUTSSA/gpuburn5min2_$INJECTION_KERNEL_COUNT.txt 300 0.00000000000000000000079997554 5247073600000000000000 