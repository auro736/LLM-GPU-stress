...
export INJECTION_METRICS=$INJECTION_METRICS"smsp__sass_thread_inst_executed_register_spilling.avg.pct_of_peak_sustained_active " # stall_memory_throttle



env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-burnSA/gpu_burn -i 0 -c ./test-apps/gpu-burnSA/compare.ptx -m 50% > data/raw/INPUTSSA/gpuburn5min0_$INJECTION_KERNEL_COUNT.txt 300 14660154687488 0.000000000000303164882520939871213272