...
env CUDA_INJECTION64_PATH=./libinjection.so ./test-apps/gpu-burnSA/gpu_burn -i 0 -c ./test-apps/gpu-burnSA/compare.ptx -m 50% > data/raw/INPUTSSA/gpuburn5min3_$INJECTION_KERNEL_COUNT.txt 300 0.0000000000000000000000000000070533445 596541420000000000000000000000