...
# this inferences should occupy 10% of the memory with an epsilon of 285.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --batch_size 1024 \
    --num_iterations 3503 > data/raw/PC/NN10Percmnasnet05_$INJECTION_KERNEL_COUNT.txt

# this inferences should occupy 10% of the memory with an epsilon of 29.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    --model_name mobilenet_v2 \
    --dataset_name CIFAR10 \
    --batch_size 512 \
    --num_iterations 2481 > data/raw/PC/NN10Percmobilenetv2_$INJECTION_KERNEL_COUNT.txt

# this inferences should occupy 10% of the memory with an epsilon of 33.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    --model_name resnet18 \
    --dataset_name CIFAR10 \
    --batch_size 1024 \
    --num_iterations 3048 > data/raw/PC/NN10Percresnet18_$INJECTION_KERNEL_COUNT.txt

# this inferences should occupy 10% of the memory with an epsilon of 257.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    --model_name LeNet5 \
    --dataset_name MNIST \
    --batch_size 10000 \
    --num_iterations 3606 > data/raw/PC/NN10PercLeNet5_$INJECTION_KERNEL_COUNT.txt