...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --dataset_name CIFAR10 \
    --batch_size 2048 \
    --duration 450 > data/raw/PC/NN50Percmobilenetv2_$INJECTION_KERNEL_COUNT.txt
...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --dataset_name CIFAR10 \
    --batch_size 4096 \
    --duration 450 > data/raw/PC/NN50Percresnet18_$INJECTION_KERNEL_COUNT.txt
...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --dataset_name MNIST \
    --batch_size 10000 \
    --duration 450 > data/raw/PC/NN50PercLeNet5_$INJECTION_KERNEL_COUNT.txt
