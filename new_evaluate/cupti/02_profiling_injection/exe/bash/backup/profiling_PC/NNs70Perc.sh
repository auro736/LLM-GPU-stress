...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --batch_size 10000 \
    --num_iterations 1383 > data/raw/PC/NN70Percmnasnet05_$INJECTION_KERNEL_COUNT.txt
...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --dataset_name CIFAR10 \
    --batch_size 4096 \
    --num_iterations 1659 > data/raw/PC/NN70Percmobilenetv2_$INJECTION_KERNEL_COUNT.txt
...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --dataset_name CIFAR10 \
    --batch_size 8912 \
    --num_iterations 1377 > data/raw/PC/NN70Percresnet18_$INJECTION_KERNEL_COUNT.txt
...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --dataset_name MNIST \
    --batch_size 10000 \
    --num_iterations 3606 > data/raw/PC/NN70PercLeNet5_$INJECTION_KERNEL_COUNT.txt