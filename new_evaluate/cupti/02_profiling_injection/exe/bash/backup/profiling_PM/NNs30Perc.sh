...
# this inferences should occupy 90% of the memory with an epsilon of 748.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --batch_size 4096 \
    --num_iterations 2225 > data/raw/PM/NN30Percmnasnet05_$INJECTION_KERNEL_COUNT.txt

# this inferences should occupy 90% of the memory with an epsilon of 998.50	MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    --model_name mobilenet_v2 \
    --dataset_name CIFAR10 \
    --batch_size 1024 \
    --num_iterations 2272 > data/raw/PM/NN30Percmobilenetv2_$INJECTION_KERNEL_COUNT.txt

# this inferences should occupy 90% of the memory with an epsilon of 1040.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    --model_name resnet18 \
    --dataset_name CIFAR10 \
    --batch_size 2048 \
    --num_iterations 2708 > data/raw/PM/NN30Percresnet18_$INJECTION_KERNEL_COUNT.txt

# this inferences should occupy 90% of the memory with an epsilon of 1824.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    --model_name LeNet5 \
    --dataset_name MNIST \
    --batch_size 10000 \
    --num_iterations 3606 > data/raw/PM/NN30PercLeNet5_$INJECTION_KERNEL_COUNT.txt