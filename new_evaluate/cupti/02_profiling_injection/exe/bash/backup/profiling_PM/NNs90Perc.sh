...
# this inferences should occupy 90% of the memory with an epsilon of 3323.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --batch_size 10000 \
    --num_iterations 3 > data/raw/PM/NN90Percmnasnet05_$INJECTION_KERNEL_COUNT.txt

# this inferences should occupy 90% of the memory with an epsilon of 2099.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    --model_name mobilenet_v2 \
    --dataset_name CIFAR10 \
    --batch_size 4096 \
    --num_iterations 1679 > data/raw/PM/NN90Percmobilenetv2_$INJECTION_KERNEL_COUNT.txt

# this inferences should occupy 90% of the memory with an epsilon of 1391.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    --model_name resnet18 \
    --dataset_name CIFAR10 \
    --batch_size 10000 \
    --num_iterations 1329 > data/raw/PM/NN90Percresnet18_$INJECTION_KERNEL_COUNT.txt

# this inferences should occupy 90% of the memory with an epsilon of 6525.50 MB for 1 hour
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    --model_name LeNet5 \
    --dataset_name MNIST \
    --batch_size 10000 \
    --num_iterations 3606 > data/raw/PM/NN90PercLeNet5_$INJECTION_KERNEL_COUNT.txt