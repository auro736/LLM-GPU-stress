...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --batch_size 4096 \
    --num_iterations 2225 > data/raw/PM/NN40Percmnasnet05_$INJECTION_KERNEL_COUNT.txt
...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --dataset_name CIFAR10 \
    --batch_size 2048 \
    --num_iterations 2078 > data/raw/PM/NN40Percmobilenetv2_$INJECTION_KERNEL_COUNT.txt
...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --dataset_name CIFAR10 \
    --batch_size 2048 \
    --num_iterations 2708 > data/raw/PM/NN40Percresnet18_$INJECTION_KERNEL_COUNT.txt
...
env CUDA_INJECTION64_PATH=./libinjection.so python3 /home/bepi/Desktop/Ph.D_/projects/GPU_stress/code/ScalableGPUMonitoring/cupti/02_profiling_injection/test-apps/NNs/evaluate.py\
    ...
    --dataset_name MNIST \
    --batch_size 10000 \
    --num_iterations 3606 > data/raw/PM/NN40PercLeNet5_$INJECTION_KERNEL_COUNT.txt